...
#ifndef BASEDLYAI_SWIFT_H
#define BASEDLYAI_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BasedlyAI",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9BasedlyAI11AppDelegate")
...
@class UIWindow;
@class UIScene;
SWIFT_CLASS("_TtC9BasedlyAI13SceneDelegate")
...
@class NSBundle;
@class NSCoder;
SWIFT_CLASS("_TtC9BasedlyAI14ViewController")
